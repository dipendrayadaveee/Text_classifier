...
from model_fn.model_fn_text_classifiers import DNN_MaxPooling1D
...
model = DNN_MaxPooling1D(embedding_dim, vocab_size, maxlen) # DNN_MaxPooling1D is a four layer neural network
# where first layer is an Embedding layer, second layer is maxpooling layer followed by a dense layer using relu
# activation and finally the last dense layer using sigmoid activation function
