...
from model_fn.model_fn_text_classifiers import DNN_WordEmbedding
...
model = DNN_WordEmbedding(embedding_dim, vocab_size, maxlen)  # DNN_WordEmbedding is a sequential four layer
# neural network where first layer is an Embedding layer, second layer is used to flatten the output of first layer
# followed by a dense layer using relu activation and finally the last dense layer using sigmoid activation function.
